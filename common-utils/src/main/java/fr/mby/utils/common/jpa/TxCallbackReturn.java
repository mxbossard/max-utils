 ...
 * 
 */
public abstract class TxCallbackReturn<T> {
	 ...
	 */
	public TxCallbackReturn(final EntityManager em) throws PersistenceException {
		super();
	 ...
	 *             which may occured during transaction processing.
	 */
	public TxCallbackReturn(final EntityManagerFactory emf) throws PersistenceException {
		super();
	...
	protected void execute(final EntityManager em) throws PersistenceException {
		try {
			...
			this.result = this.executeInTransaction(em);
	 ...
	 * @Throws PersistenceException
	 */
	protected abstract T executeInTransaction(final EntityManager em) throws PersistenceException;
